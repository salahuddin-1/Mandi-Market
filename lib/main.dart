...
//   // scrollJumpFunctions() {
//   //   scrollController = new ScrollController(initialScrollOffset: 25.w * 2);
...
//   getMoreDocuments() async {
//     final querySnap = await Database.mastersRef
...
//     documentsList.addAll(querySnap.docs);
...
//         stream: MasterDatabase.getAllUsers(
//           ownersPhoneNumber,
//           widget.type,
//         ),
...
//             documentsList.addAll(snapshot.data!.docs);

//             final masterList = documentsList
//                 .map((doc) => MasterModel.fromDocument(doc))
//                 .toList();
//             // final masterList = masterHandler.getMasterModelList(snapshot.data!);

//             lastDoc = masterHandler.getLastDocument(snapshot.data!);
